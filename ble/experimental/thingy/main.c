...
static void scan_init(void)
{
    ...
    NRF_LOG_INFO("Scan init, name: %s",  m_target_periph_name);
...
int main(void)
{
    ...
    // Start execution.
    NRF_LOG_INFO("Thing52 test 0.6.3.0 started");
